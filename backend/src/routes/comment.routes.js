...
import { addComment, getCommentsByUser, getPostComments, removePostComment } from "../controllers/comment.controllers.js";

const commentRouter = Router()

// add comment to a post
commentRouter.route('/add-commment-to-post').post(
    verifyJWT,
